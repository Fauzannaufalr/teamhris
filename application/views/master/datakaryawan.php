                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="badge" style="color: black; background-color: gold;"
                                    data-toggle="modal" data-target="#ubahDataKaryawan<?= $dk['id_karyawan']; ?>"><i
                                        class="fas fa-edit"></i> Edit</button>
                                <button type="button" class="badge" style="color: antiquewhite; background-color:  #cc0000;"
                                    data-toggle="modal" data-target="#modal-sm<?= $dk['id_karyawan'] ?>"><i
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url() ?>master/DataKaryawan/hapus/<?= $dk['id_karyawan'] ?>" type="submit" class="btn"
            ...
            <form action="<?= base_url('master/DataKaryawan/import') ?>" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
                        <button type="submit" class="btn"
                            style="background-color: #8b0000; color:white;">Import</button>
                    </div>
                </div>
            </form>
        </div>
