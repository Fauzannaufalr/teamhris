                ...
                <tbody>
                    ...
                    <?php foreach ($soalkuesioner as $sk) : ?>
                        <tr>
                            ...
                            <td><?= $sk['kuesioner']; ?></td>
                            <td>
                                <a href="" class="badge" style="background-color: #fbff39; color: black" data-toggle="modal" data-target="#ubahKuesioner<?= $sk['id_kuesioner']; ?>">edit</a>
                                <a href="" class="badge" style="background-color: #ff0000; color: black" data-toggle="modal" data-target="#modal-sm<?= $sk['id_kuesioner']; ?>">hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
