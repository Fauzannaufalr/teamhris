                    ...
                    <?php foreach ($soalrecruitment as $sr) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger" style="font-size: 12px; color: white; background-color:  #ff0000;" data-toggle="modal" data-target="#modal-sm<?= $sr['id_soal_recruitment'] ?>">hapus</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
