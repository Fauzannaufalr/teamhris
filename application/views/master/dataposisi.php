                    ...
                    <?php foreach ($dataposisi as $dp) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger" style="font-size: 14px; color: white; background-color:  #ff0000;" data-toggle="modal" data-target="#modal-sm<?= $dp['id_posisi']; ?>">hapus</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
