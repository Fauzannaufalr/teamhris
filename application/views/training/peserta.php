    ...
    <div class="col-md-12">
        ...
        <div class="box box-success" style="overflow-x: scroll;">
            <div class="box-header">
                ...
                <a href="<?php echo base_url('jenis_ujian'); ?>"><button type="button" class="btn btn-primary btn-flat"
                        data-toggle="modal" data-target="#"><span></span>Data Jenis Ujian</button></a>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?= base_url() . 'peserta/edit/' . $d->id_peserta; ?>">Edit
                                                Data</a></li>
                                        <li><a href="<?= base_url() . 'peserta/hapus/' . $d->id_peserta; ?>"
