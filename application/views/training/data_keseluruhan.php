    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <button type="button" class="btn btn-outline-success" data-toggle="modal"
                data-target="#tambahdatakeseluruhan"><i class="fas fa-plus"></i>
                Tambah Data
            </button>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-danger"
                                ...
                                data-target="#modal-sm<?= $dk['id_keseluruhan'] ?>">hapus</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
...
<div class="modal fade" id="tambahdatakeseluruhan" tabindex="-1" aria-labelledby="tambahdatakeseluruhanLabel"
    aria-hidden="true">
            ...
            <form action="<?= base_url('training/Datakeseluruhan/tambah') ?>" method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="ulasan" name="ulasan"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <a href="<?= base_url() ?>training/datakeselurahan/hapus/<?= $dk['id_keseluruhan'] ?>" type="submit"
