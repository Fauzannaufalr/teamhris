                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group date">
                                    ...
                                    <input type="date" class="form-control pull-right" id="datepicker" name="tanggal" value="<?= $p->tanggal_ujian ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="time" class="form-control" id="timepicker" name="jam" value="<?= $p->jam_ujian ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
