                ...
                <div class="box-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="select2 form-control" name="nama_posisi" required="">
                                    <option selected="selected" disabled="">- Pilih Mata Pelajaran -</option>
                                    <?php foreach($kelas as $a) { ?>
                                    <option value="<?=$a->id_posisi?>"
                                        <?php if($s->nama_posisi==$a->nama_posisi){echo "selected='selected'";} ?>>
                                        <?= $a->kode_posisi;?> | <?= $a->nama_posisi;?></option>
                                    <?php } ?>
                                </select>
